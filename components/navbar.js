...
const Navbar = () => {
  ...
  return (
    <div
      className={clsx(
        " py-[1rem]  sticky top-0 z-[200]",
        isScrolling
          ? " translate-y-[-101%]  transition-all duration-1000  ease-in-out"
          : "  translate-y-0 transition-all duration-1000 ease-in-out",
    ...
    >
      <Padding className={""}>
        <div className=" flex justify-between items-center">
          ...
          <div className={clsx("  gap-[2rem] items-center hidden md:flex")}>
            <Link href={"/login"}>
              <div
                className={clsx(
                  " text-[0.95rem] leading-none font-circular font-[450]  ",
                  params.includes("usecase1")
                    ? " text-[#95AEEF]"
                    : params.includes("usecase2")
                      ? "text-[#858A98]"
